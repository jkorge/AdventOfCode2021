...
inline bool overlap1d(const std::array<int, 2> a, const std::array<int, 2> b){
    return std::max(a.at(0), b.at(0)) <= std::min(a.at(1), b.at(1));
}

inline std::array<int, 2> intersection1d(const std::array<int, 2> a, const std::array<int, 2> b){
    return {std::max(a.at(0), b.at(0)), std::min(a.at(1), b.at(1))};
}
